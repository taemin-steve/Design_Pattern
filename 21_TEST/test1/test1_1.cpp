...
public:
    ...
    virtual void GuessNumber(int& x, int& y, int& z)
    {
        do{
            x = rand() % 9 + 1;
            y = rand() % 9 + 1;
...
class BasicBaseBallGame : public BaseBallGame
{
    void GuessNumber(int& x, int& y, int& z) override
    {   
        cout << "기본 예측" << endl;
        do{
            x = rand() % 9 + 1;
